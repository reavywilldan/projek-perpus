...
<footer class="main-footer">
  <div id="mycredit"><strong> Copyright &copy; <?php echo date('Y'); ?> Sistem Informasi Perpustakaan
...
<script src="<?php echo base_url(); ?>assets_style/assets/dist/js/qrcode.min.js"></script>
</body>
