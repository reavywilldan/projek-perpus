										...
										<tr>
											...
											<td>
												<div class="input-group">
													...
													<span class="input-group-btn">
														<a data-toggle="modal" data-target="#TableBuku" class="btn btn-primary" title="Cari buku"><i class="fa fa-search"></i></a>
														<a data-toggle="modal" data-target="#scanQrModal" class="btn btn-primary" title="Scan kode QR buku"><i class="fa fa-qrcode"></i></a>
													</span>
												</div>
											</td>
										</tr>
...
<!-- modal scan qr start -->
<div class="modal fade" id="scanQrModal" tabindex="-1" role="dialog" aria-labelledby="scanQrModalLabel" aria-hidden="true">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="scanQrModalLabel">Scan QR Code buku</h5>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
				...
				$.ajax({
					...
					success: function(html) {
						...
						if (response.success) {
							...
							$('#scanQrModal').modal('hide')
							$("#result_tunggu_buku").html('<p style="color:red"><blink>buku tidak ditemukan</blink></p>');
						}
